            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                <div class="card border border-light-subtle rounded-4">
                    <div class="card-body p-3 p-md-4 p-xl-5">
                        <div class="row">
                            <div class="col-12">
                                {{--To display session message of success--}}
                            ...
                            <div class="row gy-3 overflow-hidden">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        {{--Jab value enter karein in email input toh agar value wrong hai aur page refresh ho kay arraha hai toh value clear na ho iss liye value="{{old('email'}}" --}}
